...
#from lumin import feature_extraction as features
...
def single_cell_widget():
    ...
    @magicgui(
        ...
        deconv_taud = dict(widget_type='FloatSpinBox', name='deconv_taud', label='Tau d', value=0, step=0.1, tooltip='Tau d parameter for OASIS deconvolution. Specify the decay time constant of the fluorescence signal in seconds.'),
    ...
    #edited
    def widget(project_dir, analysis_mode, activity_type, detection_method, control_condition,  norm_label,  normalization_mode, deconv_label, deconv_taud, deconv_fr, stimulation_frame,  sliding_window_size, percentile_threshold  , spike_label,smoothing_cb, spike_prominence_threshold, spike_amplitude_width_ratio, analysis_window_start, analysis_window_end, baseline_std_threshold, imaging_interval,kcl_frame, downstream_label, n_clusters, optimization_label,stimulation_selection, optimize_button,optimize_button_previous):
    ...
    def _analysis_mode_changed():
        ...
        if widget.analysis_mode.value == 'Compound-evoked activity':
            ...
            widget.activity_type.visible = False
            widget.detection_method.visible = True #edited
...
#Edited------------------------------------------------------------
    ...
    def _detection_method_changed():
        if widget.detection_method.value == 'Peak detection':
            widget.deconv_label.visible = False
            widget.deconv_taud.visible = False
            widget.deconv_fr.visible = False

        elif widget.detection_method.value == 'Prominence only':
